# https://www.nhl.com/penguins/tickets/pps-all-stars
...
### **To unlock this special offer:**
  ...
  1. Click REDEEM TICKETS.
  2. Select your preferred game.
  3. Select your preferred seating location.
  4. Select your preferred number of tickets.Â Families receive 2 free tickets for each student.
  5. On the checkout page, enter yourÂ **discount code**.Â Â 
  6. Enter an additional discount code for each PPS student.



**The DISCOUNT CODE is your child's unique PPS username (ex: stjdoe)!

Note, credit card info should NOT be entered unless purchasing additional tickets.Â **

Redeem Tickets 

## **To Access Your Digital Tickets on Game Day:**

  1. **Download** the Penguins App in the App Store or Google Play.
  2. Select **Tickets** from the homepage menu.
  3. Tap **Manage My Tickets**.
  4. **Sign in** with the email address used during the redemption process.
  5. Click the **Game Graphic**.
  6. Tap **View Barcode.** Barcode will appear 48 hours prior to game time.



## **To Access Your Digital Food Vouchers on Game Day:**

On game day, digital food vouchers will appear in your account beneath your game tickets. Each voucher is redeemable for a 16oz fountain drink and a hot dog at PPG Paints Arenaâs âClassicsâ stands (Sections 223 & 231) or âArena Favoritesâ stands (Sections 107, 212 & 232).
...
For program terms and conditions, please click here.
...
To view your tickets, you must log in with the email address used during the redemption process. If you do not have a Ticketmaster account, one must be created. Downloading the latest version of the Pittsburgh Penguins app is also encouraged. If you still do not see the tickets, please contact the Pittsburgh Penguins Customer Service Department atÂ 412.642.1842.

remove add Is parking available at PPG Paints Arena?

On game nights, parking is available for purchase in surface lots near PPG Paints Arena. For a PPG Paints Arena parking map and pricing, pleaseÂ click here. For other downtown parking options, visit Pittsburgh Downtown Partnership'sÂ parking resources page.
...
PPG Paints Arena is a **cashless venue**. Credit and debit cards as well as Apple/Google Pay are accepted. Reverse ATMs are available to convert cash to a pre-paid debit card.
